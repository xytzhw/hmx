    ...
    function(e) {
        ...
        t = {
            ...
            spliceArray: function(e, t) {
                ...
                for (i = 0; i < e.length; i++) i !== t && (r[a] = e[i], a++);
                return r
            },
            getNum: function(e, t) {
                return t = t || 0,
            ...
            i.prototype = {
                ...
                _init: function(i, a) {
                    ...
                    a || (s.$errorContainer.hide(), s.previewInitId = "preview-" + t.uniqId(), s._initPreviewCache(), s._initPreview(!0), s._initPreviewActions(), s._setFileDropZoneTitle(), s.$parent.hasClass("file-loading") && (s.$container.insertBefore(s.$parent), s.$parent.remove())),
                ...
                _initTemplateDefaults: function() {
                    ...
                    i = '{preview}\n<div class="kv-upload-progress kv-hidden"></div><div class="clearfix"></div>\n<div class="input-group {class}">\n  {caption}\n<div class="input-group-btn">\n      {remove}\n      {cancel}\n      {upload}\n      {browse}\n    </div>\n</div>',
                        ...
                        e.each(L.defaults,
                            function(t, i) {
                                return "allowedPreviewTypes" === t ? void(void 0 === L.allowedPreviewTypes && (L.allowedPreviewTypes = i)) : void(L[t] = e.extend(!0, {},
                                    i, L[t]))
                            }),
                ...
                _initPreviewCache: function() {
                    ...
                    i.previewCache = {
                        ...
                        unset: function(e) {
                            ...
                            if (t) {
                                if (1 === t) return i.previewCache.data.content = [],
                ...
                _zoneDrop: function(e) {
                    var i = this;
                    e.preventDefault(),
                    i.isDisabled || t.isEmpty(e.originalEvent.dataTransfer.files) || (i._change(e, "dragdrop"), i.$dropZone.removeClass("file-highlighted"))
                },
                ...
                _initSortable: function() {
                    ...
                    window.KvSortable && 0 !== r.find(n).length && (i = {
                        ...
                        draggable: n,
                        onSort: function(i) {
                            var r, n, o = i.oldIndex,
                                l = i.newIndex;
                            a.initialPreview = t.moveArray(a.initialPreview, o, l),
                                a.initialPreviewConfig = t.moveArray(a.initialPreviewConfig, o, l),
                                a.previewCache.init();
                            for (var s = 0; s < a.initialPreviewConfig.length; s++) null !== a.initialPreviewConfig[s] && (n = e(i.item), r = n.closest(t.FRAMES), r.attr("data-fileindex", "init_" + s).attr("data-fileindex", "init_" + s));
                            a._raise("filesorted", {
                ...
                _clearFileInput: function() {
                    ...
                    t.isEmpty(o.val()) || (n.isIE9 || n.isIE10 ? (i = o.closest("form"), a = e(document.createElement("form")), r = e(document.createElement("div")), o.before(r), i.length ? i.after(a) : r.after(a), a.append(o).trigger("reset"), r.before(o).remove(), a.remove()) : o.val(""))
                },
                ...
                _mergeAjaxCallback: function(e, t, i) {
                    ...
                    "delete" === i && (n = r.ajaxDeleteSettings, o = r.mergeAjaxDeleteCallbacks),
                        a = n[e],
                ...
                _deleteFileIndex: function(i) {
                    ...
                    "init_" === r.substring(0, 5) && (r = parseInt(r.replace("init_", "")), a.initialPreview = t.spliceArray(a.initialPreview, r), a.initialPreviewConfig = t.spliceArray(a.initialPreviewConfig, r), a.initialPreviewThumbTags = t.spliceArray(a.initialPreviewThumbTags, r), a.getFrames().each(function() {
                        var t = e(this),
                            i = t.attr("data-fileindex");
                ...
                _setFileDropZoneTitle: function() {
                    ...
                    i.isAjaxUpload && i.showPreview && 0 !== a.length && !(i.getFileStack().length > 0) && i.dropZoneEnabled && (0 === a.find(t.FRAMES).length && t.isEmpty(i.defaultPreviewContent) && a.prepend('<div class="' + i.dropZoneTitleClass + '">' + r + "</div>"), i.$container.removeClass("file-input-new"), t.addCss(i.$container, "file-input-ajax-new"))
                },
                ...
                _change: function(i) {
                    ...
                    if (a.reader = null, a._resetUpload(), a._hideFileIcon(), a.isAjaxUpload && a.$container.find(".file-drop-zone ." + a.dropZoneTitleClass).remove(), c ? e.each(u,
                            function(e, t) {
                            ...
                            p ? e.each(u,
                                ...
                                }) : d = u), t.isEmpty(d) || 0 === d.length) return p || a.clear(),
                    ...
                    r.loadedImages = [],
                        ...
                        a = function(x) {
                            if (t.isEmpty(n.attr("multiple")) && (f = 1), x >= f) return r.isAjaxUpload && r.filestack.length > 0 ? r._raise("filebatchselected", [r.getFileStack()]) : r._raise("filebatchselected", [i]),
                                s.removeClass("file-thumb-loading"),
                                void d.html("");
                            var T, E, S, k, F, I, P, A, D, z, $, j, U = v + x,
                                B = u + "-" + U,
                                R = i[x],
                                O = m.text,
                                L = m.image,
                            ...
                            if (h > 0) for (E = 0; h > E; E++) I = g[E],
                                P = r.msgFileTypes[I] || I,
                                q += 0 === E ? P: ", " + P;
                            if (Z === !1) return void a(x + 1);
                            if (0 === Z.length) return S = r.msgInvalidFileName.replace("{name}", t.htmlEncode(R.name)),
                                void y(S, R, B, x);
                            ...
                            return 0 !== W || t.isEmpty(w) || !t.isArray(w) || t.isEmpty(H) || (F = t.compare(Z, H), W += t.isEmpty(F) ? 0 : F.length, 0 !== W) ? r.showPreview ? !C && N > b ? (r.addToStack(R), s.addClass("file-thumb-loading"), r._previewDefault(R, B), r._initFileActions(), r._updateFileDetails(f), void a(x + 1)) : (o.length && void 0 !== FileReader ? (D = O(R.type, Z), z = M(R.type, Z), $ = L(R.type, Z), d.html(c.replace("{index}", x + 1).replace("{files}", f)), s.addClass("file-thumb-loading"), l.onerror = function(e) {
                                ...
                                l.onload = function(i) {
                                    ...
                                    if (n = {
                                        ...
                                        for (o = new Uint8Array(i.target.result), E = 0; E < o.length; E++) s = o[E].toString(16),
                                            p.push(s);
                                        if (a = p.join("").toLowerCase().substring(0, 8), c = t.getMimeType(a, "", ""), t.isEmpty(c) && (d = t.arrayBuffer2String(l.result), c = t.isSvg(d) ? "image/svg+xml": t.getMimeType(a, d, R.type)), n = {
                                                name: Z,
                                                type: c
                                            },
                                ...
                                D || z ? l.readAsText(R, r.textEncoding) : $ ? l.readAsDataURL(R) : l.readAsArrayBuffer(R)) : (r._previewDefault(R, B), setTimeout(function() {
                                    a(x + 1),
                                        r._updateFileDetails(f)
                                },
                                100), r._raise("fileloaded", [R, B, x, l])), void r.addToStack(R)) : (r.isAjaxUpload && r.addToStack(R), setTimeout(function() {
                                    a(x + 1),
                                        r._updateFileDetails(f)
                                },
                                100), void r._raise("fileloaded", [R, B, x, l])) : (S = r.msgInvalidFileExtension.setTokens({
                                name: Z,
                                extensions: _
                            }), void y(S, R, B, x))
                        },
                ...
                refresh: function(i, a) {
                    var r = this,
                        n = r.$element;
                    return i = "object" != typeof i || t.isEmpty(i) ? r.options: e.extend(!0, {},
                        r.options, i),
                        r._init(i, !0),
                        r._listen(),
